...
if __name__ == "__main__":
    ...
    good4 = Good.create(name="Coca-Cola", goods_price=3, goods_description =" There are 137 calories in 1 can of Cola Soft Drink. Calorie Breakdown: 0% fat, 99% carbs, 1% prot.")
    good5 = Good.create(name="Sprite", goods_price=2.5, goods_description = " There are 139 calories in 1 can (330 ml) of Sprite Sprite (Can). Calorie Breakdown: 0% fat, 100% carbs, 0% prot.")
    good6 = Good.create(name="Fanta", goods_price=2.5, goods_description = "There are 150 calories in 1 bottle (500 ml) of Fanta Orange (500 ml). Calorie Breakdown: 0% fat, 100% carbs, 0% prot.")
    good7 = Good.create(name="Lays", goods_price=4, goods_description = "There are 192 calories in 1 serving (36 g) of Lay's Lightly Salted. Calorie Breakdown: 59% fat, 37% carbs, 5% prot.")
    good8 = Good.create(name="Pringles", goods_price=6, goods_description = "There are 210 calories in 1 serving (40 g) of Pringles Original. Calorie Breakdown: 58% fat, 40% carbs, 3% prot.")
    good9 = Good.create(name="Sandwich", goods_price=6, goods_description = "There are 252 calories in 1 Sandwich. Calorie Breakdown: 43% fat, 44% carbs, 13% prot.")
    good10 = Good.create(name="Haribo", goods_price=3.5, goods_description = "There are 336 calories in 100 g of Haribo Goldbears. Calorie Breakdown: 0% fat, 91% carbs, 8% prot.")
